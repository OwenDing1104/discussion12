...
// Question 1
document.getElementById('host-name').textContent = "Changhong Ding"
...
usernameInput.addEventListener('input', function() {
    const  enterUsername = usernameInput.value.trim();
    let usernameExists = false;

    for (let username of pokemonList) {
        if (username.toLowerCase() === enterUsername.toLowerCase()) {
            usernameExists = true;
            break;
        }
    }
